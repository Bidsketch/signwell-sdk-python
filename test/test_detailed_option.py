...
class TestDetailedOption(unittest.TestCase):
    """DetailedOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetailedOption:
        """Test DetailedOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetailedOption`
        """
