...
**placeholder_id** | **str** | Unique identifier of the placeholder assigned to the field. | 
...
template_fields_inner_inner_instance = TemplateFieldsInnerInner.from_json(json)
# print the JSON string representation of the object
print(TemplateFieldsInnerInner.to_json())

# convert the object into a dict
template_fields_inner_inner_dict = template_fields_inner_inner_instance.to_dict()
# create an instance of TemplateFieldsInnerInner from a dict
template_fields_inner_inner_from_dict = TemplateFieldsInnerInner.from_dict(template_fields_inner_inner_dict)
```
