...
class Configuration:
    ...
    conf = signwell_sdk.Configuration(
    ...
    def __init__(
        ...
        ca_cert_data: Union[str, bytes] | None = None,
        *,
        debug: bool | None = None,
    ) -> None:
        """Constructor"""
        self._base_path = "https://www.signwell.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("signwell_sdk")
        ...
        """SSL/TLS verification
           WARNING: keep this enabled in production. Set this to false only for
           short-lived local debugging against trusted test endpoints; disabling
           verification makes HTTPS requests vulnerable to interception.
        """
    ...
    def logger_file(self) -> str | None:
        ...
        Reassigning logger_file removes and closes any existing SDK file handler
    ...
    def logger_file(self, value: str | None) -> None:
        ...
        if self.logger_file_handler is not None:
            for _, logger in self.logger.items():
                if self.logger_file_handler in logger.handlers:
    ...
    def debug(self, value: bool) -> None:
        ...
        self.__debug = value
        if self.__debug:
            # If debug status is True, turn on SDK logger debug output without
            # enabling global httplib wire dumps. Raw HTTP debug output can
            # include authentication headers in application logs.
            for _, logger in self.logger.items():
    ...
    def get_basic_auth_token(self) -> str | None:
        ...
        return urllib3.util.make_headers(basic_auth=username + ":" + (self.password or "")).get("authorization")
