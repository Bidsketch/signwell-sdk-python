...
class MeResponseContact(BaseModel):
    """
    ...
    alt_phone_number: StrictStr | None = None
    website: StrictStr | None = None
    initials: StrictStr | None = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if alt_phone_number (nullable) is None
        # and model_fields_set contains the field
        if self.alt_phone_number is None and "alt_phone_number" in self.model_fields_set:
            _dict["alt_phone_number"] = None
