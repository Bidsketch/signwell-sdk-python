...
class BulkSendCsvRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["template_ids", "bulk_send_csv"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"template_ids": obj.get("template_ids"), "bulk_send_csv": obj.get("bulk_send_csv")})
