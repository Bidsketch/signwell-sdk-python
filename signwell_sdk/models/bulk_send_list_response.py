...
class BulkSendListResponse(BaseModel):
    ...
    bulk_sends: List[BulkSendListItem]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bulk_sends (list)
        _items_bulk_sends: list[Any] = []
        if self.bulk_sends:
            for _item_bulk_sends in self.bulk_sends:
                if _item_bulk_sends:
                    _items_bulk_sends.append(_item_bulk_sends.to_dict())
            _dict["bulk_sends"] = _items_bulk_sends
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "bulk_sends": [BulkSendListItem.from_dict(_item) for _item in obj["bulk_sends"]]
                if obj.get("bulk_sends") is not None
                else None,
