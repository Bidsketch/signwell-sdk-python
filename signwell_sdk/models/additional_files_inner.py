...
class AdditionalFilesInner(BaseModel):
    """
    ...
    name: StrictStr = Field(description="Name of the file that will be uploaded.")
    file_url: StrictStr | None = Field(default=None, description="Publicly available URL of the file to be uploaded.")
    file_base64: Union[StrictBytes, StrictStr] | None = Field(
        default=None, description="A RFC 4648 base64 string of the file to be uploaded."
    )
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "file_url", "file_base64"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"name": obj.get("name"), "file_url": obj.get("file_url"), "file_base64": obj.get("file_base64")}
        )
