...
class Nom151CertificateResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["nom151"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of nom151
        if self.nom151:
            _dict["nom151"] = self.nom151.to_dict()
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "nom151": Nom151CertificateResponseNom151.from_dict(obj["nom151"])
                if obj.get("nom151") is not None
                else None
            }
        )
