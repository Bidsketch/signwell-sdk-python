...
class CopiedPlaceholdersInner(BaseModel):
    """
    CopiedPlaceholdersInner
    """  # noqa: E501

    name: StrictStr = Field(description="Name of the placeholder.")
    preassigned_recipient_name: StrictStr | None = Field(
        default=None,
    ...
    preassigned_recipient_email: StrictStr | None = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["name", "preassigned_recipient_name", "preassigned_recipient_email"]
