...
class UpdateRecipientsRequest(BaseModel):
    ...
    recipients: List[UpdateRecipientsMapInner] = Field(description="List of recipients to update on the document.")
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "recipients": [UpdateRecipientsMapInner.from_dict(_item) for _item in obj["recipients"]]
