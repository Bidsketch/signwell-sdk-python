...
class MeResponseUserPreferences(BaseModel):
    """
    MeResponseUserPreferences
    """  # noqa: E501

    sales_document: StrictBool | None = None
    time_zone: StrictStr | None = None
    smart_fields: StrictBool | None = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["sales_document", "time_zone", "smart_fields"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "sales_document": obj.get("sales_document"),
                "time_zone": obj.get("time_zone"),
                "smart_fields": obj.get("smart_fields"),
            }
        )
