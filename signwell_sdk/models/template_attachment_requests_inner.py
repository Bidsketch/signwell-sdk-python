...
class TemplateAttachmentRequestsInner(BaseModel):
    """
    TemplateAttachmentRequestsInner
    """  # noqa: E501

    name: StrictStr = Field(description="Name of the requested attachment.")
    placeholder_id: StrictStr = Field(
    ...
    __properties: ClassVar[List[str]] = ["name", "placeholder_id", "required"]
