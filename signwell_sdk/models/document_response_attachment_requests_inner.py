...
class DocumentResponseAttachmentRequestsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "recipient_id", "required"]
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"name": obj.get("name"), "recipient_id": obj.get("recipient_id"), "required": obj.get("required")}
        )
