...
class DetailedOption(BaseModel):
    ...
    name: StrictStr = Field(description="Option display name")
    api_id: StrictStr | None = Field(default=None, description="Unique identifier for the option")
    is_other: StrictBool | None = Field(default=False, description='Whether this is the special "Other" option')
