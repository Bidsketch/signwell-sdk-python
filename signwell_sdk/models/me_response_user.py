...
class MeResponseUser(BaseModel):
    ...
    name: StrictStr
    email: StrictStr
    has_google_registration: StrictBool | None = None
    first_name: StrictStr | None = None
    preferences: MeResponseUserPreferences | None = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "email", "has_google_registration", "first_name", "preferences"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "email": obj.get("email"),
                "has_google_registration": obj.get("has_google_registration"),
                "first_name": obj.get("first_name"),
                "preferences": MeResponseUserPreferences.from_dict(obj["preferences"])
