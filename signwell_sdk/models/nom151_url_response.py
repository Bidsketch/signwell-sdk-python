...
class Nom151UrlResponse(BaseModel):
    """
    NOM-151 download URL returned when url_only=true
    """  # noqa: E501

    file_url: StrictStr = Field(description="Public URL to download the certificate ZIP file")
    ...
    def from_dict(cls, obj: Dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"file_url": obj.get("file_url")})
