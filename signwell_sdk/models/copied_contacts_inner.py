...
class CopiedContactsInner(BaseModel):
    """
    CopiedContactsInner
    """  # noqa: E501

    name: StrictStr | None = Field(default=None, description="Name of the copied contact.")
    email: StrictStr = Field(description="Email for the copied contact.")
