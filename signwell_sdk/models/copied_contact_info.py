...
class CopiedContactInfo(BaseModel):
    """
    Copied contact information
    """  # noqa: E501

    id: StrictStr | None = Field(default=None, description="Contact ID")
    name: StrictStr | None = Field(default=None, description="Contact name")
    email: StrictStr = Field(description="Contact email")
