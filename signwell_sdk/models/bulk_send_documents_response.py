...
class BulkSendDocumentsResponse(BaseModel):
    """
    ...
    next_page: StrictInt | None = None
    previous_page: StrictInt | None = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        _items_documents: list[Any] = []
        if self.documents:
            for _item_documents in self.documents:
                if _item_documents:
                    _items_documents.append(_item_documents.to_dict())
            _dict["documents"] = _items_documents
        ...
        _obj = cls.model_validate(
            {
                ...
                "documents": [DocumentResponse.from_dict(_item) for _item in obj["documents"]]
