...
class PaginationMeta(BaseModel):
    ...
    next_page: StrictInt | None = Field(default=None, description="Next page number, null if on last page")
    previous_page: StrictInt | None = Field(default=None, description="Previous page number, null if on first page")
    ...
    __properties: ClassVar[List[str]] = ["current_page", "next_page", "previous_page", "total_count", "total_pages"]
