...
class ApiApplicationApi:
    ...
    def delete_api_application(
        ...
        _param = self._delete_api_application_serialize(
    ...
    @validate_call
    def delete_api_application_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_api_application_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _delete_api_application_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="DELETE",
            resource_path="/api/v1/api_applications/{id}",
    ...
    def get_api_application(
        ...
        _param = self._get_api_application_serialize(
            id=id, _request_auth=_request_auth, _content_type=_content_type, _headers=_headers, _host_index=_host_index
        )

        _response_types_map: Dict[str, str | None] = {
            "200": "ApiApplicationResponse",
            "404": "ErrorResponse",
            "429": "RateLimitErrorResponse",
        }
    ...
    @validate_call
    def get_api_application_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Dict[StrictStr, Any] | None = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiApplicationResponse]:
        """Get API Application
    ...
    @validate_call
    def get_api_application_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_api_application_serialize(
        self,
        id,
        _request_auth,
        _content_type,
